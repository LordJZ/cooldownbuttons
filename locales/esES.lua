local L = LibStub("AceLocale-3.0"):NewLocale("CoolDown Buttons","esES")
...
L["Timertext Style"] = true
L["Use timed colors"] = true
L["Font Color below 20 seconds"] = true
L["Color of the CoolDown Timer Font for Cooldowns below 20 seconds."] = true
L["Font Color below 5 seconds"] = true
L["Color of the CoolDown Timer Font for Cooldowns below 5 seconds."] = true
