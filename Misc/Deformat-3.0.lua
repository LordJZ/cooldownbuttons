...
do
	...
	function Deformat:Deformat(text, a1, ...)
        assert(type(text) == "string", ("Bad argument #1 to 'Deformat' (string expected, got %s)"):format(type(text)))
        assert(type(a1)   == "string", ("Bad argument #2 to 'Deformat' (string expected, got %s)"):format(type(a1)))
